...
<!--                            <label for="access" class="col-md-4 control-label">Access</label>
 -->
                          <!--   <div class="col-md-6">
                              ...
                              <input  id="access" name="access" type="text" class="form-control" style=" width:120px"  />
                            ...
                            <div class="col-md-6 col-md-offset-6">
                                    <input type="checkbox" value="user" name="access"> user
                            </div>
                            <div class="col-md-6 col-md-offset-6">
                                    <input type="checkbox" value="admin" name="access"> admin
                            </div>
                                 @if ($errors->has('access'))
                                  <span class="help-block">
                                      <strong>{{ $errors->first('access') }}</strong>
